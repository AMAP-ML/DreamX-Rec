...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="IntBMoE recommendation model on public IntTravel data")
...
def main() -> None:
    ...
    if args.backend == "recis":
        if not recis_available():
            raise SystemExit("RecIS is not importable; use --backend torch for the public example")
